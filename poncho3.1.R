###Function developed by C S Dambros in 12th March 2012 
##Please include in acknowledgements section if essential for the work

#If you are interested in an upgraded version or other funcions, 
#please contact me by e-mail: csdambros@gmail.com

##Use

#poncho3.1(table,gradient=NULL,col=1,col.places=2,col.species=3,
...
#ylab="Abundance",show.grad=NULL,show.places=NULL,xfactor=0,lty=1,add=F,spgradient=NULL)

##Your script should have at least the table argument - poncho2.0(table)
##Arguments
...
#   xfactor           |add spaces to larger species names
...
#Start just putting your table, you can include other arguments that are all optional
#poncho3.0(table)
